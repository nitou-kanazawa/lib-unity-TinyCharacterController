...
namespace Nitou.TCC.CharacterControl.Check
{
                                      ...
                                      IEarlyUpdateComponent
    {
        ...
        [Title("Parameters")]
        [PropertyRange(0, 2f)]
        [SerializeField, Indent] private float _ambiguousDistance = 0.2f;

        /// <summary>
        /// 地面にいると認識される距離．(厳密な地面検出用）
        /// </summary>
        [PropertyRange(0, 0.5f)] 
        [SerializeField, Indent] private float _preciseDistance = 0.02f;
        ...
        private readonly Subject<GameObject> _onGroundObjectChangedSubject = new();
        ...
        /// </summary>
        public Observable<GameObject> OnGrounObjectChanged => _onGroundObjectChangedSubject;
        ...
        {
            _onGroundObjectChangedSubject.Dispose();
        }
        ...
        void IEarlyUpdateComponent.OnUpdate(float deltaTime)
        {
            ...
            if (IsChangeGroundObject)
            {
                ...
                _onGroundObjectChangedSubject.OnNext(GroundObject);
            }
        }
