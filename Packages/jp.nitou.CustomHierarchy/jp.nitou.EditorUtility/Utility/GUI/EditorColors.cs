...
namespace Nitou.EditorShared
{
    ...
    public static class EditorColors
    {
        ...
        /// 背景色
        /// </summary>
        public static Color DefaultBackground => GetColor(EditorGUIUtility.isProSkin ? "#282828" : "#A5A5A5");

        /// <summary>
        /// 背景色（非アクティブハイライト）
        /// </summary>
        public static Color HighlightBackgroundInactive => GetColor(EditorGUIUtility.isProSkin ? "#4D4D4D" : "#AEAEAE");

        /// <summary>
        /// 背景色（ハイライト）
        /// </summary>
        public static Color HighlightBackground => GetColor(EditorGUIUtility.isProSkin ? "#2C5D87" : "#3A72B0");

        /// <summary>
        /// 
        /// </summary>
        public static Color WindowBackground => GetColor(EditorGUIUtility.isProSkin ? "#383838" : "#C8C8C8");

        /// <summary>
        /// 
        /// </summary>
        public static Color InspectorTitlebarBorder => GetColor(EditorGUIUtility.isProSkin ? "#1A1A1A" : "#7F7F7F");
